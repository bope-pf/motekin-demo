...
function kr(e, t, n, r, l) {
  ...
  if (((o = 0), (r = r === "" ? "." : r + ":"), Uo(e)))
    ...
    for (e = a.call(e), u = 0; !(i = e.next()).done; )
      (i = i.value), (a = r + Nl(i, u++)), (o += kr(i, t, n, a, l));
  else if (i === "object")
    throw (
      ((t = String(e)),
      Error(
...
L.isValidElement = Qi;
L.lazy = function (e) {
  return { $$typeof: yc, _payload: { _status: -1, _result: e }, _init: Nc };
};
L.memo = function (e, t) {
 ...
 */ (function (e) {
  ...
  function r(j) {
    ...
    if (z !== P) {
      j[0] = z;
      e: for (var W = 0, Z = j.length, nr = Z >>> 1; W < nr; ) {
        var yt = 2 * (W + 1) - 1,
          kl = j[yt],
          xt = yt + 1,
          rr = j[xt];
        if (0 > l(kl, z))
          xt < Z && 0 > l(rr, kl)
            ? ((j[W] = rr), (j[xt] = z), (W = xt))
            : ((j[W] = kl), (j[yt] = z), (W = yt));
        else if (xt < Z && 0 > l(rr, z)) (j[W] = rr), (j[xt] = z), (W = xt);
        else break e;
      }
    }
    return P;
  ...
  function S(j, P) {
    ...
    try {
      ...
      if (h !== null) var nr = !0;
        ...
        var yt = n(d);
        yt !== null && wl(g, yt.startTime - P), (nr = !1);
      }
      return nr;
    } finally {
      (h = null), (m = z), (x = !1);
...
function Nu() {
  if (Gt) {
    var e = Gt,
      t = Zt;
    if (((Zt = Gt = null), Yo(e), t)) for (e = 0; e < t.length; e++) Yo(t[e]);
  }
}
function Su(e, t) {
  return e(t);
...
function _u(e) {
  return (e = Wc(e)), e !== null ? Pu(e) : null;
}
function Pu(e) {
...
var zu = xe.unstable_scheduleCallback,
  Go = xe.unstable_cancelCallback,
  Kc = xe.unstable_shouldYield,
  Yc = xe.unstable_requestPaint,
  K = xe.unstable_now,
  Xc = xe.unstable_getCurrentPriorityLevel,
  qi = xe.unstable_ImmediatePriority,
  Lu = xe.unstable_UserBlockingPriority,
  Ir = xe.unstable_NormalPriority,
  Gc = xe.unstable_LowPriority,
...
function An(e) {
  ...
  for (; 0 < tt.length && ((n = tt[0]), n.blockedOn === null); )
    Uu(n), n.blockedOn === null && tt.shift();
}
...
function to(e, t, n, r) {
  if (Ur) {
    var l = pi(e, t, n, r);
    if (l === null) Fl(e, t, r, Ar, n), Zo(e, r);
    else if (ld(l, e, t, n, r)) r.stopPropagation();
    else if ((Zo(e, r), t & 4 && -1 < rd.indexOf(e))) {
      for (; l !== null; ) {
        var i = er(l);
        if (
          (i !== null && Mu(i),
...
var an = {
  ...
  bo = ke(il),
  ad = B({}, il, { dataTransfer: 0 }),
  cd = ke(ad),
  dd = B({}, bn, { relatedTarget: 0 }),
  Ll = ke(dd),
  fd = B({}, an, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  pd = ke(fd),
  md = B({}, an, {
...
var kd = B({}, bn, {
  ...
  Ed = ke(jd),
  Cd = B({}, an, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  _d = ke(Cd),
  Pd = B({}, il, {
    deltaX: function (e) {
...
var Td = Ye && "TextEvent" in window && !_n,
  Vu = Ye && (!io || (_n && 8 < _n && 11 >= _n)),
  ns = " ",
  rs = !1;
function Bu(e, t) {
  switch (e) {
...
function Rd(e, t) {
  if (Ut)
    return e === "compositionend" || (!io && Bu(e, t))
      ? ((e = $u()), (jr = no = rt = null), (Ut = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
  ...
  if (Ye) {
    ...
    if (!Dl) {
      ...
      is.setAttribute("oninput", "return;"),
        (Dl = typeof is.oninput == "function");
    }
    Tl = Dl;
  } else Tl = !1;
  Wu = Tl && (!document.documentMode || 9 < document.documentMode);
}
function os() {
  Pn && (Pn.detachEvent("onpropertychange", Ku), ($n = Pn = null));
}
function Ku(e) {
  if (e.propertyName === "value" && ol($n)) {
    var t = [];
    Qu(t, $n, e, Ji(e)), Eu(Od, t);
  }
}
function Fd(e, t, n) {
  e === "focusin"
    ? (os(), (Pn = t), ($n = n), Pn.attachEvent("onpropertychange", Ku))
    : e === "focusout" && os();
}
function Ud(e) {
...
function sl(e) {
  ...
  var t = $t[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in Gu) return (Rl[e] = t[n]);
  return e;
}
...
for (var Ml = 0; Ml < cs.length; Ml++) {
  var Ol = cs[Ml],
    Qd = Ol.toLowerCase(),
    Wd = Ol[0].toUpperCase() + Ol.slice(1);
  ht(Qd, "on" + Wd);
}
ht(Zu, "onAnimationEnd");
ht(Ju, "onAnimationIteration");
...
function Fl(e, t, n, r, l) {
  ...
  Eu(function () {
        ...
        for (var c = d, p; c !== null; ) {
          ...
          if (
            (p.tag === 5 &&
              g !== null &&
              ((p = g),
              f !== null && ((g = In(c, f)), g != null && k.push(Hn(c, g, p)))),
            U)
          )
            break;
          c = c.return;
    ...
    if (!(t & 7)) {
      ...
      switch (((E = d ? Vt(d) : window), e)) {
        case "focusin":
          (ls(E) || E.contentEditable === "true") &&
            ((At = E), (mi = d), (zn = null));
          break;
        case "focusout":
          zn = mi = At = null;
      ...
      if (io)
        ...
        Ut
          ? Bu(e, n) && (_ = "onCompositionEnd")
          : e === "keydown" && n.keyCode === 229 && (_ = "onCompositionStart");
      _ &&
        (Vu &&
          n.locale !== "ko" &&
          (Ut || _ !== "onCompositionStart"
            ? _ === "onCompositionEnd" && Ut && (C = $u())
            : ((rt = v),
        ...
        0 < E.length &&
          ...
          C ? (_.data = C) : ((C = Hu(n)), C !== null && (_.data = C)))),
        (C = Td ? Dd(e, n) : Rd(e, n)) &&
          ((d = $r(d, "onBeforeInput")),
          0 < d.length &&
...
function fs(e, t, n, r, l) {
  for (var i = t._reactName, o = []; n !== null && n !== r; ) {
    ...
    u.tag === 5 &&
      ...
      ((u = d),
      l
        ? ((a = In(n, i)), a != null && o.unshift(Hn(n, a, u)))
        : l || ((a = In(n, i)), a != null && o.push(Hn(n, a, u)))),
      (n = n.return);
  }
...
var xi = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Zd =
    typeof queueMicrotask == "function"
      ...
      : typeof ms < "u"
      ? function (e) {
          return ms.resolve(null).then(e).catch(Jd);
        }
      : xi;
function Jd(e) {
  setTimeout(function () {
...
var cn = Math.random().toString(36).slice(2),
  ...
  wi = "__reactEvents$" + cn,
  qd = "__reactListeners$" + cn,
  bd = "__reactHandles$" + cn;
function Nt(e) {
  var t = e[Ue];
  if (t) return t;
...
function gt() {
  if (!Al && He !== null) {
    ...
    try {
      ...
      throw (He !== null && (He = He.slice(e + 1)), zu(qi, gt), l);
    } finally {
      (M = t), (Al = !1);
    }
  }
...
var Ht = [],
  ...
  We = "";
function wt(e, t) {
  (Ht[Qt++] = Wr), (Ht[Qt++] = Qr), (Qr = e), (Wr = t);
}
function ia(e, t, n) {
  (Ne[Se++] = Qe), (Ne[Se++] = We), (Ne[Se++] = Pt), (Pt = e);
  var r = Qe;
  e = We;
  var l = 32 - Re(r) - 1;
  (r &= ~(1 << l)), (n += 1);
  ...
  if (30 < i) {
    ...
    (i = (r & ((1 << o) - 1)).toString(32)),
      (r >>= o),
      (l -= o),
      (Qe = (1 << (32 - Re(t) + l)) | (n << l) | r),
      (We = i + e);
  } else (Qe = (1 << i) | (n << l) | r), (We = e);
}
function so(e) {
...
function uo(e) {
  for (; e === Qr; )
    (Qr = Ht[--Qt]), (Ht[Qt] = null), (Wr = Ht[--Qt]), (Ht[Qt] = null);
  for (; e === Pt; )
    (Pt = Ne[--Se]),
      (Ne[Se] = null),
      (We = Ne[--Se]),
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = Pt !== null ? { id: Qe, overflow: We } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
var tf = Je.ReactCurrentBatchConfig;
function yn(e, t, n) {
  if (
...
function ua(e) {
  ...
  function m(f, c, p, g) {
    ...
    if (typeof p == "object" && p !== null) {
      ...
      if (Nn(p) || pn(p)) return S !== null ? null : v(f, c, p, g, null);
      vr(f, p);
    }
    return null;
  }
  function x(f, c, p, g, S) {
    ...
    if (typeof g == "object" && g !== null) {
      ...
      if (Nn(g) || pn(g)) return (f = f.get(p) || null), v(c, f, g, S, null);
      vr(c, g);
    }
    return null;
  }
  function w(f, c, p, g) {
    for (
      var S = null, E = null, C = c, _ = (c = 0), Q = null;
      C !== null && _ < p.length;
      _++
    ) {
    ...
    if (_ === p.length) return n(f, C), A && wt(f, _), S;
    if (C === null) {
      for (; _ < p.length; _++)
        (C = h(f, p[_], g)),
          C !== null &&
            ((c = i(C, c, _)), E === null ? (S = C) : (E.sibling = C), (E = C));
      return A && wt(f, _), S;
    }
  ...
  function k(f, c, p, g) {
    ...
    for (
      var E = (S = null), C = c, _ = (c = 0), Q = null, T = p.next();
      C !== null && !T.done;
      _++, T = p.next()
    ) {
      C.index > _ ? ((Q = C), (C = null)) : (Q = C.sibling);
      var Pe = m(f, C, T.value, g);
      if (Pe === null) {
        C === null && (C = Q);
        break;
      }
    ...
    if (T.done) return n(f, C), A && wt(f, _), S;
    if (C === null) {
      for (; !T.done; _++, T = p.next())
        (T = h(f, T.value, g)),
          T !== null &&
            ((c = i(T, c, _)), E === null ? (S = T) : (E.sibling = T), (E = T));
      return A && wt(f, _), S;
    }
    ...
    if (
      ...
      switch (p.$$typeof) {
        ...
        case It:
          ...
          return o(f);
        case be:
          return (E = p._init), U(f, c, E(p._payload), g);
      }
...
function vo(e, t) {
  switch ((O(Kn, t), O(Wn, e), O(Ve, tr), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function wo(e, t, n, r, l, i) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (_r.current = e === null || e.memoizedState === null ? sf : uf),
    (e = n(r, l)),
    Ln)
  ) {
    i = 0;
...
function _a(e, t, n) {
  return zt & 21
    ? (Oe(n, t) || ((n = Du()), (V.lanes |= n), (Lt |= n), (e.baseState = !0)),
      t)
...
function Ci(e, t, n, r) {
  ...
  typeof i == "object" && i !== null
    ? (l.context = Ce(i))
    : ((i = me(t) ? _t : oe.current), (l.context = tn(e, i))),
  ...
  return (
    ...
    e !== null && !fe
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ze(e, t, l))
      : (A && n && so(t), (t.flags |= 1), se(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !fe
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ze(e, t, l))
      : (A && r && so(t), (t.flags |= 1), se(e, t, n, l), t.child)
  );
}
function Ds(e, t, n, r, l) {
  ...
  if ((qt(t, l), t.stateNode === null))
    zr(e, t), Da(t, n, r), Ci(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      u = t.memoizedProps;
    o.props = u;
    ...
    (o.state = m),
      ...
      u !== r || m !== a || pe.current || et
        ? (typeof v == "function" && (Ei(t, n, v, r), (a = t.memoizedState)),
          (u = et || Es(t, n, u, r, m, a, d))
            ? (h ||
...
function zi(e, t, n, r, l, i) {
  Fa(e, t);
  var o = (t.flags & 128) !== 0;
  if (!r && !o) return l && gs(t, n, !1), Ze(e, t, i);
...
function Rs(e, t, n, r, l) {
  return nn(), ao(l), (t.flags |= 256), se(e, t, n, r), t.child;
}
...
function ff(e, t, n, r, l, i, o) {
  ...
  if (((u = (o & e.childLanes) !== 0), fe || u)) {
    ...
    return Lo(), (r = Ql(Error(y(421)))), gr(e, t, o, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((uo(t), t.tag)) {
    ...
    case 6:
      if (e && t.stateNode != null) Ha(e, t, e.memoizedProps, r);
        ...
        if (((n = jt(Kn.current)), jt(Ve.current), hr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Ue] = t),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || $.current & 1 ? G === 0 && (G = 3) : Lo())),
          t.updateQueue !== null && (t.flags |= 4),
          le(t),
          null);
    case 4:
      return (
        ln(), Di(e, t), e === null && Bn(t.stateNode.containerInfo), le(t), null
      );
    case 10:
...
function gf(e, t) {
  ...
  for (gi = { focusedElem: e, selectionRange: n }, Ur = !1, N = t; N !== null; )
...
function Qa(e) {
  ...
  t !== null && ((e.alternate = null), Qa(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ue], delete t[Qn], delete t[wi], delete t[qd], delete t[bd])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ya(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      ze(t, e), Ie(e), r & 512 && n !== null && Kt(n, n.return);
      break;
    case 5:
      if (
        (ze(t, e),
      ...
      if (r & 4 && ((l = e.stateNode), l != null)) {
        ...
        if (((e.updateQueue = null), a !== null))
          try {
            u === "input" && i.type === "radio" && i.name != null && hu(l, i),
              oi(u, o);
            var d = oi(u, i);
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((ie = (d = ie) || v), ze(t, e), (ie = d)) : ze(t, e),
        Ie(e),
        r & 8192)
      ) {
        if (
          ...
          for (N = l; N !== null; )
            (o = N),
              ...
              o.tag === 22 && o.memoizedState !== null
                ...
                ? ((a.return = o), (N = a))
                : $s(l);
        for (; i !== null; ) (N = i), Xa(i), (i = i.sibling);
        (N = l), (yr = u), (ie = d);
      }
      Us(e);
    } else
      l.subtreeFlags & 8772 && i !== null ? ((i.return = l), (N = i)) : Us(e);
  }
}
function Us(e) {
  for (; N !== null; ) {
...
function Me(e, t, n, r) {
  ...
  qn(e, n, r),
    (!(D & 2) || e !== q) &&
      (e === q && (!(D & 2) && (pl |= n), G === 4 && nt(e, te)),
      he(e, r),
      n === 1 && D === 0 && !(t.mode & 1) && ((sn = K() + 500), al && gt()));
}
function he(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Go(n), t === 1))
      e.tag === 0 ? ef(Vs.bind(null, e)) : la(Vs.bind(null, e)),
        Zd(function () {
          !(D & 6) && gt();
        }),
        (n = null);
...
function Ga(e, t) {
  if (((Lr = -1), (Tr = 0), D & 6)) throw Error(y(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = tl(e, r);
    ...
    D |= 2;
    var i = Ja();
    (q !== e || te !== t) && ((Be = null), (sn = K() + 500), Et(e, t));
    do
      try {
        Nf();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = Zn), Et(e, 0), nt(e, r), he(e, K()), n);
    if (t === 6) nt(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (nt(e, r), (r & 130023424) === r && ((t = _o + 500 - K()), 10 < t))
          ) {
            if (Fr(e, 0) !== 0) break;
            ...
            e.timeoutHandle = xi(kt.bind(null, e, de, Be), t);
            break;
          }
          kt(e, de, Be);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = xi(kt.bind(null, e, de, Be), r);
            break;
          }
          kt(e, de, Be);
          break;
  ...
  return he(e, K()), e.callbackNode === n ? Ga.bind(null, e) : null;
}
function Ai(e, t) {
  var n = Dn;
  return (
...
function Vs(e) {
  ...
  if (n === 1) throw ((n = Zn), Et(e, 0), nt(e, t), he(e, K()), n);
...
function Tt(e) {
  ...
  try {
    ...
    (M = r), (Ee.transition = n), (D = t), !(D & 6) && gt();
  }
}
function zo() {
  (ve = Yt.current), F(Yt);
...
function Lo() {
  (G === 0 || G === 3 || G === 2) && (G = 4),
    q === null || (!(Lt & 268435455) && !(pl & 268435455)) || nt(q, te);
}
function tl(e, t) {
  var n = D;
  D |= 2;
  var r = Ja();
  (q !== e || te !== t) && ((Be = null), Et(e, t));
  do
    try {
      kf();
      break;
  ...
  while (!0);
  if ((fo(), (D = n), (qr.current = r), Y !== null)) throw Error(y(261));
...
function kt(e, t, n) {
  var r = M,
    l = Ee.transition;
  try {
    (Ee.transition = null), (M = 1), Sf(e, t, n, r);
  } finally {
    (Ee.transition = l), (M = r);
  }
  return null;
...
function bt() {
  if (lt !== null) {
    var e = Ru(el),
      ...
      n = M;
    try {
      if (((Ee.transition = null), (M = 16 > e ? 16 : e), lt === null))
        var r = !1;
      else {
        ...
        if (
          ((D = l), gt(), $e && typeof $e.onPostCommitFiberRoot == "function")
        )
          try {
...
function jf(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    q === e &&
      (te & n) === n &&
      (G === 4 || (G === 3 && (te & 130023424) === te && 500 > K() - _o)
        ? Et(e, 0)
        : (Co |= n)),
    he(e, t);
}
...
tc = function (e, t, n) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || pe.current) fe = !0;
      ...
      if (!(e.lanes & n) && !(t.flags & 128)) return (fe = !1), pf(e, t, n);
      fe = !!(e.flags & 131072);
    }
  else (fe = !1), A && t.flags & 1048576 && ia(t, Wr, t.index);
  switch (((t.lanes = 0), t.tag)) {
    case 2:
      var r = t.type;
      zr(e, t), (e = t.pendingProps);
      var l = tn(t, oe.current);
      qt(t, n), (l = wo(null, t, r, e, l, n));
      var i = ko();
      return (
        (t.flags |= 1),
        typeof l == "object" &&
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            Ci(t, r, e, n),
            (t = zi(null, t, r, !0, i, n)))
          : ((t.tag = 0), A && i && so(t), se(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
      ...
      e: {
        ...
        if (((r = o.element), i.isDehydrated))
          if (
            ...
            (l = on(Error(y(423)), t)), (t = Rs(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = on(Error(y(424)), t)), (t = Rs(e, t, r, n, l));
            break e;
          } else
            for (
...
function Dr(e, t, n, r, l, i) {
  ...
  if (((r = e), typeof e == "function")) To(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Zl:
        return (
          (e = je(12, n, t, l | 2)), (e.elementType = Zl), (e.lanes = i), e
        );
      case Jl:
        return (e = je(13, n, t, l)), (e.elementType = Jl), (e.lanes = i), e;
      case ql:
        return (e = je(19, n, t, l)), (e.elementType = ql), (e.lanes = i), e;
      case fu:
        return ml(n, l, i, t);
      default:
...
function Df(e, t, n, r, l) {
  ...
  var a = Do(e, 0, !1, null, null, !1, !1, "", Qs);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (bi(t, n | 1), he(t, K()), !(D & 6) && ((sn = K() + 500), gt()));
      }
      break;
    case 13:
      Tt(function () {
...
Su = Po;
ju = Tt;
var Rf = { usingClientEntryPoint: !1, Events: [er, Vt, ul, ku, Nu, Po] },
  wn = {
...
var Of = ou.exports,
  sc,
  Ws = Of;
(sc = Ws.createRoot), Ws.hydrateRoot;
/**
    ...
    const n = Ae.forwardRef(
      (
        ...
        Ae.createElement(
          ...
          [
            ...t.map(([h, m]) => Ae.createElement(h, m)),
            ...(Array.isArray(a) ? a : [a]),
          ]
        )
    );
 ...
 */ const Gf = b("X", [
  ...
  Zf = ({ question: e, answer: t, isOpen: n, onClick: r }) =>
    s.jsxs("div", {
...
function Jf() {
  const [e, t] = Ae.useState(0),
    [n, r] = Ae.useState(!1),
    [l, i] = Ae.useState(null);
  Ae.useEffect(() => {
    const a = () => t(window.scrollY);
    return (
  ...
  const o = (a) => {
      ...
      d && (d.scrollIntoView({ behavior: "smooth" }), r(!1));
    },
    u = [
      {
        question: "本当に続けられますか？",
        answer:
          "97%のお客様が3ヶ月間継続されています。専任トレーナーによる徹底サポートと、モチベーション維持プログラムであなたをゴールまで導きます。",
      },
      {
        question: "どのくらいで効果が出ますか？",
        answer:
          "個人差はありますが、2週間目から体の変化を実感し始め、1ヶ月目で周りから気づかれるレベルの変化が期待できます。3ヶ月で平均+6kgの筋量アップを実現しています。",
      },
      {
        question: "食事制限はありますか？",
        answer:
          "極端な食事制限は一切ありません。バルクアップに特化した栄養指導で、しっかり食べながら理想の体を作ります。むしろ今より多く食べる方が多いです。",
      },
      {
        question: "返金保証はありますか？",
        answer:
          "30日間の全額返金保証があります。効果に満足いただけなかった場合、理由を問わず全額返金いたします。",
      },
    ];
  return s.jsxs("div", {
    ...
    children: [
            ...
            s.jsxs("div", {
              ...
              children: [
                s.jsxs("div", {
                  ...
                  children: [
                    s.jsx(Xl, { className: "w-8 h-8 text-[#D72631]" }),
                    s.jsx("a", {
                      href: "/",
                      ariaLabel: "ホームへ戻る",
                ...
                s.jsxs("nav", {
                  ...
                  children: [
                    s.jsx("button", {
                      onClick: () => o("features"),
                      className:
                        "text-gray-700 hover:text-[#D72631] transition-colors",
                      children: "特徴",
                    }),
                    s.jsx("button", {
                      onClick: () => o("results"),
                ...
                s.jsx("button", {
                  ...
                  onClick: () => r(!n),
                  children: n
                    ? s.jsx(Gf, { className: "w-6 h-6" })
                    : s.jsx(Qf, { className: "w-6 h-6" }),
                }),
              ],
            }),
            n &&
                ...
                children: s.jsxs("div", {
                  ...
                  children: [
                    s.jsx("button", {
                      onClick: () => o("features"),
                      className:
                        "text-left text-gray-700 hover:text-[#D72631] transition-colors",
                      children: "特徴",
                    }),
                    s.jsx("button", {
                      onClick: () => o("results"),
      ...
      s.jsxs("section", {
        className:
          "min-h-screen bg-gradient-to-br from-[#D72631] to-[#F46036] text-white relative overflow-hidden",
        style: {
          backgroundImage:
            "url('https://images.pexels.com/photos/3490348/pexels-photo-3490348.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080')",
          backgroundSize: "cover",
          backgroundPosition: "center",
          backgroundBlendMode: "overlay",
        },
        children: [
          s.jsx("div", { className: "absolute inset-0 bg-[#D72631]/70" }),
          s.jsx("div", { className: "demo-badge", children: "このページはデモサイトです" }),
          s.jsx("div", {
            className: "relative z-10 container mx-auto px-4 py-32 md:py-40",
            children: s.jsxs("div", {
...
// ...
s.jsx("h1", {
    className: "text-4xl font-bold text-white md:text-6xl flex justify-center",
...
s.jsx("p", {
    ...
    children: "横浜駅徒歩5分"
                ...
                s.jsxs("div", {
                  className:
                    "bg-white/20 backdrop-blur-sm rounded-lg p-6 mb-8 max-w-2xl mx-auto",
                  children: [
                    s.jsx("p", {
                      className: "text-lg font-semibold mb-2",
                      children: "科学的バルクアップ理論 × 恋愛成功サポート",
                    }),
                    s.jsx("p", {
                      className: "text-white/90",
                      children: "3ヶ月で平均 +6kgの筋量アップ実績",
                    }),
                  ],
                }),
                s.jsxs("button", {
                  className:
                    "bg-white text-[#D72631] px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors shadow-lg",
                  children: [
                    "今すぐ無料カウンセリングを予約する",
                    s.jsx(Af, { className: "inline w-5 h-5 ml-2" }),
                  ],
                }),
              ],
            }),
            ...
            s.jsxs("div", {
              ...
              children: [
                s.jsxs("div", {
                  ...
                  children: [
                    s.jsx(Xs, {
                      className: "w-16 h-16 text-[#D72631] mx-auto mb-4",
                    }),
                    s.jsx("h3", {
                    ...
                    s.jsx("p", {
                      className: "text-gray-600 feature-text",
                      children:
            ...
            s.jsxs("div", {
              ...
              children: [
                s.jsx("h2", {
                  className:
                    "text-3xl md:text-4xl font-bold text-gray-800 mb-4",
                  children: "実際の変化をご覧ください",
                }),
                s.jsx("p", {
                  className: "text-xl text-gray-600",
                  children: "3ヶ月で人生が変わった男性たち",
                }),
              ],
            }),
            s.jsxs("div", {
                ...
                s.jsxs("div", {
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        s.jsxs("div", {
                          ...
                          children: [
                            ...
                            s.jsx("p", {
                              className: "mt-2 font-semibold text-[#D72631]",
                              children: "AFTER",
                            }),
                          ],
                        }),
                    ...
                    s.jsxs("div", {
                      ...
                      children: [
                        s.jsx("p", {
                          className: "text-2xl font-bold text-[#D72631] mb-2",
                          children: [
    "10kg減量",
    s.jsx("br", {}),
    "+8kg筋量アップ"
                        ...
                        s.jsx("p", {
                          ...
                          children: "田中さん (28歳・会社員)",
                        }),
                        s.jsx("p", {
                          className: "text-sm text-gray-500 mt-2 feature-text",
                          children:
              ...
              children: s.jsxs("div", {
                ...
                children: [
                  s.jsxs("div", {
                    ...
                    children: [
                      s.jsx("div", {
                        className: "text-4xl font-bold text-[#D72631] mb-2",
                        children: "97%",
                      }),
                      s.jsx("div", {
                        className: "text-gray-600",
            ...
            s.jsxs("div", {
              ...
              children: [
                s.jsx("h2", {
                  className:
                    "text-3xl md:text-4xl font-bold text-gray-800 mb-4",
                  children: "モテキンの専用プログラム",
                }),
                s.jsx("p", {
                  className: "text-xl text-gray-600",
                  children: "自信と魅力を両立する専用プログラム",
                }),
              ],
            }),
            s.jsxs("div", {
              ...
              children: [
                s.jsxs("div", {
                  ...
                  children: [
                    s.jsx(Xl, { className: "w-12 h-12 text-[#D72631] mb-4" }),
                    s.jsx("h3", {
                      className: "text-2xl font-bold mb-4",
                      children: "パーソナルトレーニング",
                    }),
                    s.jsxs("ul", {
                ...
                s.jsxs("div", {
                  className: "bg-white p-8 rounded-lg shadow-lg",
                  children: [
                    s.jsx(Xs, { className: "w-12 h-12 text-[#D72631] mb-4" }),
                    s.jsx("h3", {
                      className: "text-2xl font-bold mb-4",
                      children: "栄養コンサルティング",
                    }),
                ...
                s.jsxs("div", {
                  className: "bg-white p-8 rounded-lg shadow-lg",
                  children: [
                    s.jsx(Ys, { className: "w-12 h-12 text-[#D72631] mb-4" }),
                    s.jsx("h3", {
                      className: "text-2xl font-bold mb-4",
                      children: "メンタルサポート",
                    }),
                ...
                s.jsxs("div", {
                  className: "bg-white p-8 rounded-lg shadow-lg",
                  children: [
                    s.jsx(Xf, { className: "w-12 h-12 text-[#D72631] mb-4" }),
                    s.jsx("h3", {
                      className: "text-2xl font-bold mb-4",
                      children: "アフターサポート",
                    }),
            ...
            s.jsxs("div", {
              ...
              children: [
                s.jsx("h2", {
                  className:
                    "text-3xl md:text-4xl font-bold text-gray-800 mb-4",
                  children: "経験豊富なトレーナー陣",
                }),
                s.jsx("p", {
                  className: "text-xl text-gray-600",
                  children: "男性専門の資格を持つプロフェッショナル",
                }),
              ],
            }),
            s.jsxs("div", {
                ...
                s.jsxs("div", {
                  ...
                  children: [
                    ...
                    s.jsxs("div", {
                      ...
                      children: [
                        s.jsx(Ot, { className: "w-6 h-6 text-[#D72631]" }),
                        s.jsx(Ot, { className: "w-6 h-6 text-[#D72631]" }),
                        s.jsx(Ot, { className: "w-6 h-6 text-[#D72631]" }),
                      ],
                    }),
                    s.jsx("p", {
                      className: "text-sm text-gray-600 feature-text",
                      children:
          ...
          children: [
            s.jsxs("div", {
              ...
              children: [
                ...
                s.jsx("p", {
                  className: "text-xl",
  style: { color: "#ef4444" }, // Tailwindのred-500相当
                  children: "今だけ30%OFFキャンペーン実施中！",
                }),
              ],
            }),
            s.jsxs("div", {
              ...
              children: [
                  ...
                  children: [
                    ...
                    s.jsxs("div", {
                      ...
                      children: [
                        ...
                        s.jsx("div", {
                          className: "text-4xl font-bold text-[#D72631]",
                          children: "208,600円",
                        }),
                        s.jsx("div", {
                    ...
                    s.jsx("button", {
                      className:
                        "w-full bg-gray-200 text-gray-800 py-3 rounded-lg font-semibold hover:bg-gray-300 transition-colors",
                      children: "プラン詳細を見る",
                    }),
                  ],
                }),
                s.jsxs("div", {
                  className:
                    "bg-white p-8 rounded-lg shadow-lg border-4 border-[#D72631] relative",
                  children: [
                    s.jsx("div", {
                      className:
                        "absolute -top-4 left-1/2 transform -translate-x-1/2 bg-[#D72631] text-white px-4 py-2 rounded-full text-sm font-semibold",
                      children: "人気No.1",
                    }),
                    s.jsx("h3", {
                      className: "text-2xl font-bold mb-4",
                    ...
                    s.jsx("button", {
                      className:
                        "w-full bg-[#D72631] text-white py-3 rounded-lg font-semibold hover:bg-[#b51e2a] transition-colors",
                      children: "このプランで申し込む",
                    }),
                  ],
                }),
            ...
            s.jsxs("div", {
              ...
              children: [
                s.jsxs("div", {
                  ...
                  children: [
                    s.jsx(Kf, { className: "w-6 h-6 text-[#D72631]" }),
                    s.jsx("span", {
      ...
      s.jsx("section", {
        className: "py-20 bg-[#E85A6B] text-white",
        children: s.jsxs("div", {
          className: "container mx-auto px-4 text-center",
          children: [
            s.jsx("h2", {
              className: "text-3xl md:text-4xl font-bold mb-6",
              children: "今すぐあなたの人生を変えよう",
            }),
            s.jsx("p", {
              className: "text-xl mb-8 max-w-2xl mx-auto ",
              children:
                "無料カウンセリングで、あなたの理想の体と人生設計を一緒に考えます。 横浜駅から徒歩5分、完全予約制のプライベート空間でお待ちしています。",
            }),
            s.jsxs("div", {
              className:
              ...
              children: [
                s.jsx("button", {
                  className:
                    "bg-white text-[#D72631] px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors",
                  children: "無料カウンセリング予約",
                }),
                s.jsx("button", {
                  className:
                    "border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white hover:text-[#E85A6B] transition-colors",
                  children: "30%OFFで体験トレーニング",
                }),
              ],
            }),
            s.jsx("p", {
                    ...
                    s.jsxs("div", {
                      ...
                      children: [
                        s.jsxs("div", {
                          className: "flex items-center space-x-2",
                          children: [
                            s.jsx(Hf, { className: "w-4 h-4" }),
                            s.jsx("span", { children: "横浜駅西口徒歩5分" }),
                          ],
                        }),
                      ],
                    }),
                    ...
                    s.jsxs("div", {
                      ...
                      children: [
                        s.jsxs("div", {
                          className: "flex items-center space-x-2",
                          children: [
                            s.jsx(Wf, { className: "w-4 h-4" }),
                            s.jsx("span", { children: "045-23-4567" }),
                          ],
                        }),
                        s.jsxs("div", {
                          className: "flex items-center space-x-2",
                          children: [
                            s.jsx(Bf, { className: "w-4 h-4" }),
                            s.jsx("span", { children: "info@motekin.jp" }),
                          ],
                        }),
                        s.jsxs("div", {
    className: "flex items-center space-x-2",
    ...
    children: [
        s.jsx(Vf, { className: "w-4 h-4" }),
        s.jsx("span", { children: "@motekin_yokohama" }),
    ],
}),
                      ],
                    }),
    ...
    s.jsxs("div", {
      ...
      children: [
        s.jsxs("div", {
          className: "hour-row",
          children: [
            s.jsx("span", { className: "day", children: "月〜金" }),
            s.jsx("span", { className: "time no-wrap", children: "7:00〜23:00" }),
          ],
        }),
        s.jsxs("div", {
          className: "hour-row",
          children: [
            s.jsx("span", { className: "day", children: "土・日" }),
            s.jsx("span", { className: "time no-wrap", children: "9:00〜20:00" }),
          ],
        }),
        s.jsxs("div", {
          className: "hour-row",
          children: [
            s.jsx("span", { className: "day", children: "祝日" }),
            s.jsx("span", { className: "time no-wrap", children: "10:00〜18:00" }),
          ],
        }),
        s.jsx("div", {
          ...
          children: "年中無休",
            ...
            s.jsx("div", {
              ...
              children: s.jsx("p", {
                children: "© 2024 モテキン. All rights reserved.",
              }),
            }),
          ],
        }),
      ...
      s.jsx("div", {
        className: `fixed bottom-4 right-4 z-50 transition-transform duration-300 ${
          e > 100 ? "translate-y-0" : "translate-y-20"
        }`,
        children: s.jsx("button", {
          className:
            "bg-[#D72631] text-white px-6 py-3 rounded-full shadow-lg hover:bg-[#b51e2a] transition-colors font-semibold",
          children: "無料相談予約",
        }),
      }),
    ],
...
sc(document.getElementById("root")).render(
  s.jsx(Ae.StrictMode, { children: s.jsx(Jf, {}) })
);
